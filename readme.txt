...
Thanks to @borkweb, the plugin is now compatible with the WP Debug Bar plugin (http://wordpress.org/extend/plugins/debug-bar/) for extra debugging goodness!
